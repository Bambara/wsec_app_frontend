...
import 'grn_custom_row.dart';

class LoadItemsAPI {
  static Future<Uint8List> generateGRN(
    List<LoadedProduct> vLoadItems,
    String vehicleNum,
    ...
    final List<CSCustomRow> elements = [
      for (var product in vLoadItems) CSCustomRow(product.product.product_code, product.product.name, product.sale_price.toString(), product.quantity.toString()),
    ];
