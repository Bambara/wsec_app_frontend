...
import 'invoice_custom_row.dart';
...
class InvoiceAPI {
  static Future<Uint8List> generateInvoice(
    ...
    final List<InvoiceCustomRow> elements = [
      for (var product in invoice.invoice_products)
        InvoiceCustomRow(product.stock_product.product_code, product.stock_product.name, product.stock_product.sale_price.toString(), product.qty.toString()),
    ];
    final image = (await rootBundle.load('assets/images/company_logo.jpg')).buffer.asUint8List();
      ...
      pw.MultiPage(
        ...
        header: (context) {
          return pw.Column(children: [
            ...
            invoiceNumberInfo(invoice.customer_id, invoice.cashier_id, invoice.create_time),
