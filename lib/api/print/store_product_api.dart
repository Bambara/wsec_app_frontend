...
import 'store_product_custom_row.dart';
...
class StoreProductAPI {
  static Future<Uint8List> generateInvoice(
    ...
    final List<StoreProductCustomRow> elements = [
      for (var product in products) StoreProductCustomRow(product.product_code, product.name, product.bar_code, product.status),
    ];
    final logo = (await rootBundle.load('assets/images/company_logo.jpg')).buffer.asUint8List();
    ...
    return pw.Row(
      ...
      children: [
        pw.Column(
          mainAxisAlignment: pw.MainAxisAlignment.center,
          children: [
            pw.Text("Store Product List", style: const pw.TextStyle(fontSize: 12)),
            /*pw.Row(children: [
  ...
  static pw.Widget invoiceNumberInfo() {
        ...
        children: [
          ...
          pw.Row(
            children: [
              ...
              pw.Text(DateFormat.yMMMEd().format(DateTime.now()), style: const pw.TextStyle(fontSize: 10)),
            ],
          ),
  ...
  static pw.Widget rowHeaders() {
    return pw.Row(children: [
      ...
      pw.Expanded(child: pw.Text('Bar Code', textAlign: pw.TextAlign.right, style: const pw.TextStyle(fontSize: 10))),
      pw.Expanded(child: pw.Text('Status', textAlign: pw.TextAlign.right, style: const pw.TextStyle(fontSize: 10))),
    ]);
  }
  ...
  static pw.Widget itemColumn(List<StoreProductCustomRow> elements) {
    return pw.Column(
      children: [
        for (var element in elements)
          pw.Column(mainAxisAlignment: pw.MainAxisAlignment.start, children: [
            ...
            pw.Row(
              ...
              children: [
                pw.Expanded(child: pw.Text(element.productCode, textAlign: pw.TextAlign.left, style: const pw.TextStyle(fontSize: 8))),
                pw.Expanded(child: pw.Text(element.productName, textAlign: pw.TextAlign.left, style: const pw.TextStyle(fontSize: 8))),
                pw.Expanded(child: pw.Text(element.barCode, textAlign: pw.TextAlign.right, style: const pw.TextStyle(fontSize: 8))),
                pw.Expanded(child: pw.Text(element.status, textAlign: pw.TextAlign.right, style: const pw.TextStyle(fontSize: 8))),
              ],
            ),
            //pw.SizedBox(height: 2),
            pw.SizedBox(height: 2),
