...
class LTWInvoiceFinish extends StatelessWidget {
  LTWInvoiceFinish({
    Key? key,
                      ...
                      children: [
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(quotation[index].create_time, style: const TextStyle(fontSize: 14)),
                                  IconButtonWidget(
                                      imagePath: '',
                                      function: () {
                                        // selectItem(index);
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Customer : ${quotation[index].customer_id.toString()}', style: const TextStyle(fontSize: 14)),
                                ],
                              ),
                            )
                          ],
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Total Value : ${quotation[index].bd_amount.toString()}', style: const TextStyle(fontSize: 14)),
                              SizedBox(
