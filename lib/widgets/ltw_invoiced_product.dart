...
class LTWInvoicedProduct extends StatelessWidget {
  LTWInvoicedProduct({
    Key? key,
  ...
  final List<InvoiceProduct> productList;
  final int index;
                      ...
                      children: [
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(productList[index].stock_product.name, style: const TextStyle(fontSize: 14)),
                                  IconButtonWidget(
                                      imagePath: '',
                                      function: () {
                                        // selectItem(index);
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text('Dis. : ${productList[index].ld_amount.toStringAsPrecision(3)}', style: const TextStyle(fontSize: 14)),
                            SizedBox(
                              width: screenWidth * 0.05,
                            ),
                            Text('Dis % : ${productList[index].ld_percentage.toStringAsPrecision(3)}', style: const TextStyle(fontSize: 14)),
                          ],
                        ),
                        SizedBox(
